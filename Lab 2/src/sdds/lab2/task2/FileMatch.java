 ...
 * @version 1.0
 * @since 08/02/2022
 * @see sdds.lab2.task2.TransactionRecord
 * @see sdds.lab2.task2.Account
 */
public class FileMatch {
    ...
    private void serializeTransactionData() {
        ...
        tr.add(new TransactionRecord(300, 83.89));
        tr.add(new TransactionRecord(400, 100.56));
        tr.add(new TransactionRecord(700, 80.78));
        tr.add(new TransactionRecord(700, 1.53));
     ...
     * object from the collection and continue looping to find further records for same account number.
